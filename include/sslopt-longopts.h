...
#define PREF_EXP0_INTERNAL()
#define PREF_EXP1_INTERNAL(pref) pref
...
EMBED_SSL_LONGOPTS_HAVE_OPENSSL_INTERNAL(PREF_EXP1_INTERNAL, opts_varname.)   \
EMBED_SSL_LONGOPTS_MARIADB_CLIENT_INTERNAL(PREF_EXP1_INTERNAL, opts_varname.)
#else
/* The macro to embed ssl long options as separate variables */
#define SSL_LONGOPTS_EMBED_VARS                                 \
EMBED_SSL_LONGOPTS_HAVE_OPENSSL_INTERNAL(PREF_EXP0_INTERNAL)    \
EMBED_SSL_LONGOPTS_MARIADB_CLIENT_INTERNAL(PREF_EXP0_INTERNAL)
